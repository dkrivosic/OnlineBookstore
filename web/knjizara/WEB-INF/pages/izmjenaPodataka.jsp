...
<html>
	...
	<div class="a">
		...
		<tr>
		<td>Nadimak</td><td><input type="text" name="nadimak" value="${zapis.nadimak}" size="20" maxlength="40" readonly="readonly"></td>
		</tr>
		<tr>
		...
		<tr>
		<td>Lozinka</td><td><input type="password" name="lozinka" value="${zapis.lozinka}" size="20" maxlength="40"></td>
		</tr>
		<tr>
		<td>Potvrdi lozinku</td><td><input type="password" name="kontrola" value="${zapis.lozinka}" size="20" maxlength="40"></td>
		<td><c:if test="${zapis.imaPogresku('kontrola')}">
			<div class="greska"><c:out value="${zapis.dohvatiPogresku('kontrola')}" /></div>
		</c:if></td>
		</tr>
		<tr style="text-align:center">
		<td><input type="submit" name="metoda" value="Spremi promjene"></td>
